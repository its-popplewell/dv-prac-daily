...
# ╔═╡ 20c4b4f0-8fcd-11ee-243f-2f291d5bf670
using Gadfly, RDatasets;

# ╔═╡ 393d154f-29a2-43b3-ae97-ef17538ffe32
md"## LEARNING GADFLY! FOLLOWING TUTORIAL FOR DAY 1"

# ╔═╡ 53e5f5c4-b797-451e-8313-8463d0611f0b
iris = dataset("datasets", "iris");

# ╔═╡ e7e761f0-f1e0-4c90-b2bd-d351235bebbc
plot(iris, x=:SepalLength, y=:SepalWidth, Geom.point)

# ╔═╡ 14a42575-93c4-459f-9a71-f2ca2a261f77
# plot(data::DataFrame, mapping::Dict, elements::Element...)

# ╔═╡ 7bb0841d-97cb-4585-8d97-ce57adaaf126
md"OR"

# ╔═╡ aababbfc-e156-40e7-9fd3-2a616de7225c
...
# ╔═╡ 475342bb-c67b-4308-9d1c-e7deb308a255
begin
	ps = get_to_it(iris)
	map(display, ps)
end

# ╔═╡ fcae9e88-3977-4daf-a751-6547aae9f2ae
md"To combine the two"

# ╔═╡ f20d6964-a457-4eb9-9123-2eb145ad3dff
plot(iris, x=:SepalLength, y=:SepalWidth, Geom.point, Geom.line)

# ╔═╡ f0108e73-e7fa-4101-9347-2d812957fd36
md"## Adding Color!"

# ╔═╡ d1820d3c-ce88-4aa3-a72e-4bd47f740208
plot(iris, x=:SepalLength, y=:SepalWidth, color=:Species, Geom.point)

# ╔═╡ 61b323e6-23f8-4fbb-954c-a74881ec34b8
md"# Starting Discrete Scales Tomorrow!"

# ╔═╡ 4ac830e1-fd51-4672-ae25-dcacb1296721
